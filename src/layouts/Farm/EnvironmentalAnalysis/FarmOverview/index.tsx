...
export const FarmOverview = ({ farmId }: FarmOverviewProps) => {
  ...
  const handleSubmitRequest = async () => {
    ...
    setIsLoading(true);
    const toastId = toast.loading("Enviando solicitação de análise socioambiental...");

    try {
      await api.post(`/agrotools/analise/consulta/${farmId}`);
    ...
    <div className="max-w-6xl mx-auto my-8">
        ...
        <TableInformation.Section title="Informações Propriedades">
          <TableInformation.Row columnsPerRow={4}>
            <TableInformation.Column>
              <TableInformation.Title>Nome da Propriedade</TableInformation.Title>
              <TableInformation.Value>{farm.nomePropriedade}</TableInformation.Value>
            </TableInformation.Column>
            <TableInformation.Column>
              <TableInformation.Title>Município</TableInformation.Title>
              <TableInformation.Value>{farm.cidade?.nome}</TableInformation.Value>
            </TableInformation.Column>
            <TableInformation.Column>
            ...
            <TableInformation.Column>
              ...
              <TableInformation.Value>{farm.endereco?.cep}</TableInformation.Value>
            </TableInformation.Column>
          ...
          <TableInformation.Row columnsPerRow={2}>
            <TableInformation.Column>
              ...
              <TableInformation.Value>{farm.endereco?.logradouro}</TableInformation.Value>
            </TableInformation.Column>
            <TableInformation.Column>
              <TableInformation.Title>Complemento</TableInformation.Title>
              <TableInformation.Value>{farm.endereco?.complemento}</TableInformation.Value>
            </TableInformation.Column>
          </TableInformation.Row>
          ...
          <TableInformation.Row columnsPerRow={3}>
            <TableInformation.Column>
              ...
              <TableInformation.Value>{farm.moduloFiscal}</TableInformation.Value>
            </TableInformation.Column>
            <TableInformation.Column>
              <TableInformation.Title>Tamanho da Propriedade</TableInformation.Title>
            ...
            <TableInformation.Column>
              ...
              <TableInformation.Value>{farm.statusVoucher ? "Sim" : "Não"}</TableInformation.Value>
            </TableInformation.Column>
          </TableInformation.Row>

          <TableInformation.Row columnsPerRow={3}>
            <TableInformation.Column>
              <TableInformation.Title>Atividade Principal</TableInformation.Title>
              <TableInformation.Value>{String(farm.idAtividadePrincipal)}</TableInformation.Value>
            </TableInformation.Column>
            <TableInformation.Column>
              <TableInformation.Title>Ciclo de Produção</TableInformation.Title>
              <TableInformation.Value>{String(farm.idClicloProducao)}</TableInformation.Value>
            </TableInformation.Column>
            <TableInformation.Column>
              <TableInformation.Title>Número de Proprietários</TableInformation.Title>
              <TableInformation.Value>{String(farm.numeroProprietarios)}</TableInformation.Value>
            </TableInformation.Column>
          </TableInformation.Row>

          <TableInformation.Row columnsPerRow={2}>
            <TableInformation.Column>
              <TableInformation.Title>Cadastro Ambiental Rural (CAR)</TableInformation.Title>
              <TableInformation.Value>{farm.carFederal}</TableInformation.Value>
            </TableInformation.Column>
            <TableInformation.Column>
              <TableInformation.Title>Código voucher PREM</TableInformation.Title>
        ...
        <TableInformation.Section title="Proprietário Principal">
          <TableInformation.Row columnsPerRow={3}>
            <TableInformation.Column>
              ...
              <TableInformation.Value>{owner?.pessoa.nome}</TableInformation.Value>
            </TableInformation.Column>
            <TableInformation.Column>
              <TableInformation.Title>CPF/CNPJ</TableInformation.Title>
              <TableInformation.Value>{owner?.pessoa.cpfCnpj}</TableInformation.Value>
            </TableInformation.Column>
            <TableInformation.Column>
              <TableInformation.Title>RG/Inscrição Social</TableInformation.Title>
              <TableInformation.Value>
          ...
          <TableInformation.Row columnsPerRow={3}>
            <TableInformation.Column>
              <TableInformation.Title>Data de Nascimento</TableInformation.Title>
              <TableInformation.Value>{owner?.pessoa.dataNascimento}</TableInformation.Value>
            </TableInformation.Column>
            <TableInformation.Column>
              <TableInformation.Title>Telefone</TableInformation.Title>
              <TableInformation.Value>{owner?.pessoa.telefone}</TableInformation.Value>
            </TableInformation.Column>
            <TableInformation.Column>
              <TableInformation.Title>Email</TableInformation.Title>
              <TableInformation.Value>{owner?.pessoa.email}</TableInformation.Value>
            </TableInformation.Column>
          </TableInformation.Row>
        </TableInformation.Section>

        {coOwners.map((coOwner, index) => (
          <TableInformation.Section key={index} title={`Coproprietário ${index + 1}`}>
            <TableInformation.Row columnsPerRow={3}>
              <TableInformation.Column>
                <TableInformation.Title>Nome/Razão Social</TableInformation.Title>
                <TableInformation.Value>{coOwner.pessoa.nome}</TableInformation.Value>
              </TableInformation.Column>
              <TableInformation.Column>
                <TableInformation.Title>CPF/CNPJ</TableInformation.Title>
                <TableInformation.Value>{coOwner.pessoa.cpfCnpj}</TableInformation.Value>
              </TableInformation.Column>
              <TableInformation.Column>
                <TableInformation.Title>RG/Inscrição Social</TableInformation.Title>
                <TableInformation.Value>{coOwner.pessoa.rgInscricaoSocial || "—"}</TableInformation.Value>
              </TableInformation.Column>
            </TableInformation.Row>
            ...
            <TableInformation.Row columnsPerRow={3}>
              <TableInformation.Column>
                <TableInformation.Title>Data de Nascimento</TableInformation.Title>
                <TableInformation.Value>{coOwner.pessoa.dataNascimento}</TableInformation.Value>
              </TableInformation.Column>
              <TableInformation.Column>
                <TableInformation.Title>Telefone</TableInformation.Title>
                <TableInformation.Value>{coOwner.pessoa.telefone}</TableInformation.Value>
              </TableInformation.Column>
              <TableInformation.Column>
                <TableInformation.Title>Email</TableInformation.Title>
                <TableInformation.Value>{coOwner.pessoa.email}</TableInformation.Value>
              </TableInformation.Column>
            </TableInformation.Row>
          </TableInformation.Section>
        ))}
      ...
      <div className="flex items-center gap-4 mt-6">
        ...
        <label className="text-sm text-[#0A3503]" htmlFor="accept">
          Declaro, para todos os fins de direito, e sob penas de lei, que os dados informados e documentos apresentados são legítimos. E que autorizo o compartilhamento de meus dados para consultas públicas para análise socioambiental perante aos órgãos necessários.
        </label>
      </div>
